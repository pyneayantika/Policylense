...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 flex h-16 items-center justify-around border-t border-stone-300 bg-white/95 backdrop-blur px-2 md:hidden">
      {NAV_ITEMS.map((item) => {
        ...
        return (
          ...
          >
            <Icon size={18} className={active ? "text-[#1a6b5a]" : "text-stone-400"} />
