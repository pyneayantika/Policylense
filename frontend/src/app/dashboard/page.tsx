...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4 border-b border-stone-300/80 pb-4">
        <div>
          ...
          <h1 className="text-3xl font-bold tracking-tight text-stone-900 mt-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/chat"
            className="inline-flex items-center gap-1.5 rounded-xl border border-stone-300 bg-white px-4 py-2.5 text-xs font-semibold text-stone-800 shadow-2xs hover:bg-stone-50 transition-all"
          >
      ...
      {isLoading && !summary && (
        <div className="rounded-xl bg-amber-50 p-4 text-xs font-medium text-amber-800 border border-amber-200 animate-pulse">
          Refreshing protection intelligence & rules engine evaluation...
        </div>
      )}

      {!isLoading && !hasPolicies && (
        <div className="rounded-2xl border-2 border-dashed border-stone-300 bg-stone-50 p-10 text-center space-y-4">
          <Upload size={40} className="mx-auto text-stone-400" />
          <h3 className="text-lg font-bold text-stone-700">No policies analyzed yet</h3>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl bg-stone-900 p-6 text-white shadow-md">
        <div>
